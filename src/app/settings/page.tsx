        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-md p-8">
          ...
          <div className="flex gap-4">
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex-1 px-6 py-3 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 disabled:bg-gray-400 transition"
            >
              {saving ? '保存中...' : '保存'}
            </button>
            <button
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-md p-8 mt-8">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 disabled:bg-gray-400 transition"
            >
